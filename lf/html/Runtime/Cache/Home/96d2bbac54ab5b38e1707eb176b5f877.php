...
<link href="/lf/html/Public/Home/css/bootstrap-tour.min.css" rel="stylesheet">
...
<link href="/lf/html/Public/Home/css/index.min.css" rel="stylesheet">
<style>
body, html {
	overflow: hidden;
}
...
<div id="container" class="effect mainnav-fixed navbar-fixed footer-fixed mainnav-lg">
	...
	<div id="navbar-container">
		<div class="navbar-header">
			...
			<img alt="Logo" class="brand-icon" src="/lf/html/Public/Home/images/frame/logo.png">
					...
					<div class="clearfix">
						...
						<div class="col-sm-4 col-md-3" id="menu_member">
							<ul class="list-unstyled">
								<li class="dropdown-header"><img alt="" src="/lf/html/Public/Home/images/frame/11.png">会员中心</li>
								<li>
						...
						<div class="col-sm-4 col-md-3" id="menu_proxy">
							<ul class="list-unstyled">
								<li class="dropdown-header"><img alt="" src="/lf/html/Public/Home/images/frame/12.png">代理中心</li>
						...
						<div class="col-sm-4 col-md-3">
							<ul class="list-unstyled">
								<li class="dropdown-header"><img alt="" src="/lf/html/Public/Home/images/frame/13.png">服务中心</li>
								...
								<li class="divider"></li>
								<li class="dropdown-header"><img alt="" src="/lf/html/Public/Home/images/frame/14.png">资金中心</li>
								<li>
	...
	<img alt="" src="/lf/html/Public/Home/images/frame/av7.png"><span id="user_nickname" style="color:#515151;"><?php echo ($this->iff($user['nickname'],$user['nickname'],$user['username'])); ?></span>
	</a>
	</li>
	<li class="jifen"><img alt="" src="/lf/html/Public/Home/images/frame/10.png">余额：<span id="user_sscmoney" style="color:red;"><?php echo ($user["coin"]); ?></span>元<span id="j-refresh" class="fa fa-refresh" action="<?php echo U('index/userinfo');?>" style="cursor:pointer;"></span></li>
	<li>
		...
		<div id="mainnav">
			<div id="mainnav-shortcut" class="mainnav-widget">
				<ul class="list-unstyled newmenu">
					...
					<img alt="" src="/lf/html/Public/Home/images/frame/c.png"><strong>充值</strong>
					</a>
					</li>
					<li title="" data-original-title="" class="col-xs-6">
					<a class="shortcut-grid" href="<?php echo U('cash/index');?>" target="pageframe">
					<img alt="" src="/lf/html/Public/Home/images/frame/t.png"><strong>提现</strong>
					</a>
					</li>
				</ul>
			</div>
				...
				<div class="nano has-scrollbar">
					<div style="right: -17px;" tabindex="0" class="nano-content">
						<ul id="mainnav-menu" class="list-group">
							...
							<img alt="" src="/lf/html/Public/Home/images/frame/0.png">
							...
							<img alt="" src="/lf/html/Public/Home/images/frame/1.png">
							...
							<ul aria-expanded="true" class="pop-in collapse in">
                                ...
                                <li><a href="<?php echo U('game/game?type=5&groupId=2');?>" target="pageframe">激情60秒<span class="pull-right badge badge-success">新</span></a></li>								
							...
							<li>
							<a class="" title="" data-original-title="" href="#">
							<img alt="" src="/lf/html/Public/Home/images/frame/2.png">
							...
							<ul class="collapse pop-in">
								...
								<li><a href="<?php echo U('game/game?type=15&groupId=10');?>" target="pageframe">重庆11选5</a></li>
								<li><a href="<?php echo U('game/game?type=16&groupId=10');?>" target="pageframe">江西11选5</a></li>							
							</ul>
							</li>
							<li>
							<a class="" title="" data-original-title="" href="#">
							<img alt="" src="/lf/html/Public/Home/images/frame/3.png">
							...
							<li>
							<a class="" title="" data-original-title="" href="#">
							<img alt="" src="/lf/html/Public/Home/images/frame/4.png">
							...
							<img alt="" src="/lf/html/Public/Home/images/frame/5.png">
							<span class="menu-title">
                                    优惠活动
							...
							<img alt="" src="/lf/html/Public/Home/images/frame/8.png">
							<span class="menu-title">
                                    自动投注软件
							...
							<li>
							<a class="" title="" data-original-title="" href="javascript:$.niftyNoty({type:%20'danger',icon:%20'fa%20fa-minus',message:%20'%E5%B7%A5%E7%A8%8B%E5%B8%88%E6%AD%A3%E5%9C%A8%E5%8A%AA%E5%8A%9B%E5%AE%8C%E5%96%84%E4%B8%AD%E3%80%82%E3%80%82%E3%80%82%E3%80%82%E3%80%82%E3%80%82',container:%20'floating',timer:%203000});">
							<img alt="" src="/lf/html/Public/Home/images/frame/9.png">
...
<div class="sidemsg" id="chat_main">
	<div class="sidetitle">
		<img alt="" src="/lf/html/Public/Home/images/frame/tx.jpg">会员昵称 
		<span>
		<a href="javascript:void(0)" class="minimask" id="chat_mini">
		<img alt="" src="/lf/html/Public/Home/images/frame/mini.png" title="最小化在线客服">
		</a>
		<a href="javascript:void(0)" class="closemask" id="chat_exit">
		<img alt="" src="/lf/html/Public/Home/images/frame/cha.png" title="关闭在线客服">
		</a>
		</span>
	</div>
					...
					<div class="list-group bg-trans renlist" id="renlist">
						...
						<div class="list-group bg-trans">
							...
							<div class="media-left">
								<img class="img-circle img-xs" src="/lf/html/Public/Home/images/frame/av4.png" alt="Profile Picture">
							</div>
							...
							<div class="media-left">
								<img class="img-circle img-xs" src="/lf/html/Public/Home/images/frame/av1.png" alt="Profile Picture" id="imgSupState">
							</div>
							<div class="media-body">
								<div class="text-lg">
									上级
...
<div id="j-play" style="display: none; width: 0px; height: 0px;">
	<img style="width: 0px; height: 0px; display: none;" id="jp_poster_0"><audio src="/lf/html/Public/Home/images/frame/5097.mp3" preload="metadata" id="jp_audio_0"></audio>
</div>
...
<script src="/lf/html/Public/Home/js/fastdata.js"></script>
<script src="/lf/html/Public/Home/js/jquery.jplayer.min.js"></script>
<script src="/lf/html/Public/Home/js/layout.min.js"></script>
...
<script language="javascript" type="text/javascript">
  if(! /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
	nitalk();
	configtalk('<?php echo $user["username"];?>', '<?php echo md5($user['password']);?>', 'http://<?php echo $_SERVER['SERVER_NAME'];?>/nitalk/', 'newbee', '<?php echo S('WEB_NAME');?>' , '<?php echo U('team/linkList');?>', '');
