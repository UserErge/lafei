...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>欢迎您登录-拉菲娱乐-管理系统</title>
        <link rel="stylesheet" type="text/css" href="/lf/html/Public/Admin/css/login.css" media="all">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><i class="login-logo"></i>拉菲娱乐-管理系统</h3>
