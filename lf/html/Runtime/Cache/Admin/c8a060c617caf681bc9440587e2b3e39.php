...
<body>
	...
	<form action="/lf/html/admin.php?s=/admin/menu/index.html" method="post">
		<div class="cf">
			...
			<div class="search-form fr cf">
				<div class="sleft">
					...
					<!-- <a class="sch-btn" href="javascript:;" id="search" url="/lf/html/admin.php?s=/admin/menu/index.html"><i class="btn-search"></i></a> -->
				</div>
				<div class="sbtn">
